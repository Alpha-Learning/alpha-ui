...
export default function FirstSection({ scrollY }: { scrollY: number }) {
  ...
  return (
    <section id="about" className="min-h-[80vh] sm:min-h-[85vh] lg:min-h-screen py-10 sm:py-16 lg:py-20 bg-gray-50 flex items-center relative overflow-hidden">
      {/* Animated background orbs */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="hidden sm:block absolute -top-8 left-1/4 w-40 h-40 bg-gradient-to-r from-teal-200 to-teal-300 rounded-full opacity-30 animate-pulse"></div>
        <div className="hidden sm:block absolute top-10 right-1/5 w-28 h-28 bg-gradient-to-r from-blue-200 to-blue-300 rounded-full opacity-25 animate-pulse" style={{animationDelay: '0.8s'}}></div>
        <div className="hidden sm:block absolute bottom-10 left-1/3 w-20 h-20 bg-gradient-to-r from-purple-200 to-purple-300 rounded-full opacity-25 animate-pulse" style={{animationDelay: '1.6s'}}></div>
