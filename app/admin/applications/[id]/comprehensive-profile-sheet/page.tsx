...
export default function ComprehensiveProfileSheetPage() {
  ...
  const { clearStorage } = useFormPersistence(
    watch,
    setValue,
    'admin-comprehensive-profile-sheet',
    params.id as string
  );
  ...
  const handleAutofill = () => {
    const autofillData = getAutofillData('comprehensiveProfileSheet');
    const currentValues = watch();
    
    // Preserve personal information fields
    const personalInfoFields = ['childName', 'childAge', 'assessmentDate'];
