...
export default function ParentLearnerReportPage() {
  ...
  const loadReport = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await apiService.get(`/api/applications/${params.id}/learner-report`);
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-600 text-lg">Loading Learner Report...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg border border-red-200 p-6">
            <div className="text-center py-12">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 mb-2">Unable to Load Report</h2>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
            <div className="text-center py-12">
              <p className="text-gray-600 mb-6 text-lg">Report not available</p>
              <button
                onClick={() => router.push('/dashboard/user')}
                className="px-6 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors"
              >
          ...
          <div className="flex items-start justify-between">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <h1 className="text-4xl font-bold text-gray-900">UTL AI Analysis Report</h1>
